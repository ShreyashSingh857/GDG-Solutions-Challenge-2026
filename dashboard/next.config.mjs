...
const cspHeader = `
	...
	connect-src 'self' https://*.supabase.co https://firestore.googleapis.com https://*.googleapis.com https://api.cesium.com https://ion.cesium.com https://assets.ion.cesium.com https://dev.virtualearth.net https://*.virtualearth.net wss: ws: http://localhost:* https://*.tile.openstreetmap.org https://tile.openstreetmap.org;
