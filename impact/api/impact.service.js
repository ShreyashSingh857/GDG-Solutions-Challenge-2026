...
export async function processDisruptionEvent(agentPayload) {
	...
	const impactReport = createImpactReport({ disruptionId: disruption.id, disruptionType: disruption.type, traceId, affectedShipments: scoredShipments, cascadeRisk: geminiResult.cascadeRisk || 'MEDIUM', urgency: geminiResult.urgency || disruption.severity, totalCargoAtRiskUSD, analysisText: geminiResult.analysisText || '' });
